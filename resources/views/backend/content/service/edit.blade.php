...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <Form action="/service/update/{{ $service->service_id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
