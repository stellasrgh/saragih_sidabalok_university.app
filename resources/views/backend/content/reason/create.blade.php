...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <Form action="/reason/store" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="the_reason_form" name="the_reason"
                            placeholder="Input the Reason" value="{{ old('the_reason') }}">
                    </div>
                    <div class="mb-3">
